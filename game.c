...
const char *moveDoc1 = "./chpt1.txt";
const char *moveDoc2 = "./chpt2.txt";
const char *moveDoc3 = "./chpt3.txt";
const char *moveDoc4 = "./chpt4.txt";
const char *moveDoc5 = "./chpt5.txt";
const char *moveDoc6 = "./chpt6.txt";
const char *moveDoc7 = "./chpt7.txt";
const char *moveDoc8 = "./chpt8.txt";

const char *itemDoc1 = "./items1.txt";
const char *itemDoc2 = "./items2.txt";
const char *itemDoc3 = "./items3.txt";
const char *itemDoc4 = "./items4.txt";

const char *MurrayDocument = "./murray.txt";
const char *CravenDocument = "./craven.txt";
const char *DoughlandDocument = "./doughland.txt";
const char *MilwuakeeJoeDocument = "./milwuakeeJoe.txt";
